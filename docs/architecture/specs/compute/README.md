...
![Workflow JSON Model](images/compute-workflow.png)
...
![Publishing & Executing a Compute Service](images/computing-setup.png)
...
![Execution Flow](images/execution-orchestration.png)
